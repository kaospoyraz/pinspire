...
const PinspireApp = () => {
  ...
  const [allPins, setAllPins] = useState([
    ...
    { 
      id: 103, 
      image: "https://images.unsplash.com/photo-1495567720989-cebdbdd97913?w=400", 
      title: "Aşk", 
      description: "Sevgi", 
      category: "Duygu", 
      userId: 0, 
  ...
  const getSimilarPins = (pin) => 
    allPins
      .filter(p => p.id !== pin.id && p.category === pin.category)
      .slice(0, 6);
  ...
  const filteredPins = useMemo(() => {
    ...
    if (showProfile && viewingUserId !== null) {
      result = result.filter(pin => pin.userId === viewingUserId);
    } else if (showProfile && viewingUserId === null) {
        ...
        <header className="bg-white shadow-sm sticky top-0 z-40">
          <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <button 
              ...
              className="px-4 py-2 bg-purple-500 text-white rounded-full font-semibold text-sm"
            >
              Paylaş
            </button>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6">
              ...
              <div className="grid grid-cols-3 gap-3">
                <button 
                  ...
                  className={`p-4 rounded-xl border-2 flex flex-col items-center gap-2 ${
                    newPost.type === "photo" ? "border-purple-500 bg-purple-50" : "border-gray-200"
                  }`}
                >
                  <ImageIcon size={24} />
                ...
                <button 
                  ...
                  className={`p-4 rounded-xl border-2 flex flex-col items-center gap-2 ${
                    newPost.type === "video" ? "border-purple-500 bg-purple-50" : "border-gray-200"
                  }`}
                >
                  <Video size={24} />
                ...
                <button 
                  ...
                  className={`p-4 rounded-xl border-2 flex flex-col items-center gap-2 ${
                    newPost.type === "text" ? "border-purple-500 bg-purple-50" : "border-gray-200"
                  }`}
                >
                  <Type size={24} />
            ...
            {newPost.type !== "text" && (
              <div className="mb-4">
                ...
                <input 
                  type="file" 
                  accept={newPost.type === "photo" ? "image/*" : "video/*"} 
    ...
    return (
      <div className="min-h-screen bg-gray-50 pb-20">
        ...
        <div className="max-w-4xl mx-auto p-4 text-center py-20">
          ...
          <h3 className="text-xl font-bold mb-2">Henüz mes​​​​​​​​​​​​​​​​
